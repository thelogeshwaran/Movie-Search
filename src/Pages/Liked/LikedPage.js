            ...
            <div className="liked__list">
            {
                movies.length>0 ? movies.map((movie)=> (
                    <div>
                        ...
                        <div className="liked__remove"><IconButton style={{backgroundColor:"#1F2937", color:"white", marginRight:"10px" }} onClick={()=>removeLike(movie.id)}><ClearIcon/></IconButton>Remove</div>
                    </div>
                ))
                :
